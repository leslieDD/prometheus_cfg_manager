          ...
          <el-row type="flex" class="row-bg">
            <el-col :span="12">
              <el-form-item label="拉流域名" prop="live_domain">
                <el-input style="width: 300px;" v-model="rtmpInfo.live_domain" placeholder="拉流量域名" autocomplete
                  name="live_domain">
                </el-input>
              </el-form-item>
            </el-col>
            <el-form-item label="流名称" prop="live_name">
              <el-input style="width: 300px;" v-model="rtmpInfo.live_name" placeholder="流名称" autocomplete
                name="live_name"></el-input>
            </el-form-item>
          </el-row>
          <el-row type="flex" class="row-bg">
            <el-col :span="12">
            ...
            <el-col :span="6">
              <el-form-item label="有效期" prop="unix_time">
                <el-input style="width: 300px;" v-model="rtmpInfo.unix_time" placeholder="有效期" autocomplete
                  name="unix_time"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
