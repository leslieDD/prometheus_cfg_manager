              ...
              <template #default="{ node, data }">
                <span class="custom-tree-node">
                  ...
                  <span v-if="data.tree_type === 'idc'">
                    ...
                    <el-tooltip :content="expand_idc_title[data.id]" placement="top">
                     <span>
                    ...
                    <el-tooltip :content="view_idc_title[data.id]" placement="top">
                     <span>
                  ...
                  <span v-if="data.tree_type === 'line'">
                    ...
                    <el-tooltip :content="expand_line_title[data.id]" placement="top">
                     <span>
                    ...
                    <el-tooltip :content="view_line_title[data.id]" placement="top">
                     <span>
