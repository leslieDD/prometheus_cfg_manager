  ...
  <div class="instance_box">
    <div class="instance_action">
      <div class="instance_action_btn_left">
        <div>
          <el-tag type="warning">功能说明：导入其它prometheus实例数据</el-tag>
        </div>
        <el-form :inline="true" size="small" :rules="rules" ref="instanceInfo" :model="instanceInfo"
          class="demo-form-inline-get">
          ...
          <el-form-item>
            <el-button v-if="getDataStatus === false" type="primary" @keyup.enter="onGetInstanceData('instanceInfo')"
              plain icon="el-icon-download" @click="onGetInstanceData('instanceInfo')">获取数据</el-button>
      ...
      <div class="instance_action_btn_right">
        <el-form :inline="true" size="small" :model="instanceInfo" class="demo-form-inline-put">
          ...
          <el-form-item>
            <el-button v-if="putDataStatus === false" type="primary" plain icon="el-icon-upload2" @click="onSubmit">导入数据
            </el-button>
      ...
      <el-card class="box-card-left" shadow="never">
        ...
        <div height="100%" class="box-card-left-body">
          <el-scrollbar class="card-scrollbar">
            <el-table size="mini" highlight-current-row border :data="currPageTargetsJobsData" stripe
              :row-style="rowStyle" :cell-style="cellStyle" header-align="center"
              @selection-change="handleSelectionChange" ref="multipleTableRef" :row-key="getRowKeys">
              ...
              <el-table-column type="expand">
                <template #default="props">
                  <el-descriptions title="IP列表" size="mini" :column="3" border>
                    <el-descriptions-item v-for="(addr, i) in props.row.addrs" :key="i" :label="i + 1">{{ addr }}
                    </el-descriptions-item>
                  </el-descriptions>
                </template>
              </el-table-column>
              <el-table-column label="JOB组名" prop="name" header-align="center" show-overflow-tooltip>
              </el-table-column>
              <el-table-column label="端口号" prop="port" align="center" width="120px" header-align="center">
              </el-table-column>
              <el-table-column label="IP数" prop="addr_count" align="center" header-align="center" width="80px">
              </el-table-column>
              <el-table-column label="up" prop="up" align="center" header-align="center" width="60px">
              </el-table-column>
              <el-table-column label="down" prop="down" align="center" header-align="center" show-overflow-tooltip
                width="60px">
              </el-table-column>
          ...
          <div class="block">
            <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
              :current-page="currentPage" :page-sizes="[20, 30, 50, 100]" :page-size="pageSize"
      ...
      <el-card class="box-card-right" shadow="never">
        <template #header>
          <div class="card-header">
            ...
            <span>
              <el-input size="small" placeholder="请输入JsonPath规则" @keyup.enter="onSearchJson()"
                v-model="searchJsonContent" :class="currInputClass" style="width: 300px">
                <template #append>
                  <el-button size="small" @click="onSearchJson()" icon="el-icon-search"></el-button>
                </template>
              </el-input>
            </span>
          </div>
