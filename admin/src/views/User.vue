<template>
  <div class="user-board">
      ...
      <div>
        <div class="do_action">
          <div style="padding-right: 15px">
            <el-button size="small" type="success" icon="el-icon-baseball" plain @click="doAdd()">添加用户</el-button>
          </div>
          <div>
        ...
        <div class="table-show">
          <el-scrollbar height="75vh" class="flex-content">
            <el-table size="mini" highlight-current-row border :data="ManagerUser" stripe :row-style="rowStyle"
              ...
              <el-table-column label="密码" show-overflow-tooltip prop="password">
              </el-table-column>
    ...
    <el-dialog :title="dialogTitle" v-model="dialogVisible" width="510px" modal :before-close="handleClose">
      <span>
        <el-form label-position="right" :rules="rules" ref="ManagerUserRef" :model="ManagerUserRef" label-width="auto"
          ...
          <el-form-item label="手机：" prop="phone">
            <el-input style="width: 340px" v-model="ManagerUserRef.phone"></el-input>
          </el-form-item>
          <el-form-item label="所属组：" prop="group_id">
            <el-select v-model="ManagerUserRef.group_id" class="borderNone" popper-class="pppselect" size="small"
              collapse-tags placeholder="请选择" style="width: 340px">
              <el-option style="width: 340px" v-for="item in ManagerGroup" :key="item.id" :label="item.name"
                :value="item.id">
              </el-option>
            </el-select>
          </el-form-item>
          <el-form-item size="small">
            <el-button size="small" type="primary" @click="onSubmit('ManagerUserRef')">{{ buttonTitle }}</el-button>
            <el-button size="small" type="info" @click="onCancel('ManagerUserRef')">取消</el-button>
          </el-form-item>
        </el-form>
      </span>
    </el-dialog>
