<template>
  <div class="main-board">
    <div class="person-center-btn">
      <div>
        <el-button size="mini" type="danger" @click="goControlCenter">
          <single-svg icon-class="wxctl" />控制中心
        </el-button>
      </div>
      <div><span>&nbsp;&nbsp;</span></div>
      <div>
    ...
    <div>
      <el-dialog v-model="dialogVisible" title="Prometheus服务控制中心" width="600px" :before-close="handleClose">
...
export default {
  ...
  methods: {
    handleTabClick (tab, event) {
      ...
      } else if (tab.instance.props.name === 'noticeCrontab') {
        this.$router.push({ name: 'noticeCrontab' })
