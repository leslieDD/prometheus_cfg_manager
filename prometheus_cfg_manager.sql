...
CREATE TABLE IF NOT EXISTS `log_setting` (
  ...
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb3 COMMENT = '日志设置';
...
CREATE TABLE IF NOT EXISTS `manager_group` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name_unique` (`name`)
) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb3 COMMENT = '用户组';
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb3 COMMENT = '用户';
...
VALUES (
    ...
    'admin',
    '管理员',
    'c1c16f8cc7bf67249899a778b1974ef6',
    '10086',
    '32179eff-a5f5-4c1d-aa1a-fb72c757df9b',
    1,
    '2022-09-14 15:49:50',
    1,
    '2022-09-14 15:49:50',
...
CREATE TABLE IF NOT EXISTS `operation_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb3 COMMENT = '操作日志';
...
CREATE TABLE IF NOT EXISTS `options` (
  ...
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb3 COMMENT = '选项';
...
CREATE TABLE IF NOT EXISTS `page_function` (
  ...
  PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb3 COMMENT = '页面功能';
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb3 COMMENT = '重写标签的配置';
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb3 COMMENT = '用户登录会话';
...
VALUES (
    182,
    '9e9bce76-08d6-4393-8141-d73ce4fff02d',
    '127.0.0.1:45412',
    1,
    '2022-09-15 15:50:54',
    '2022-09-14 16:09:40'
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb3 COMMENT = '模板字段';
